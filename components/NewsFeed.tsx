                    ...
                    news.map((item) => (
                        ...
                        >
                            <div className="flex justify-between items-start">
                                <span className="text-[10px] font-bold tracking-wider text-gray-500 uppercase">{item.source} • {item.time}</span>
                                ...
                                {item.sentiment === 'neutral' && <Minus className="w-4 h-4 text-gray-500" />}
                            </div>
